...
RUNS = [
    ...
    ("A2_lossgate_strat",     "MobileNetV3-S - learned gate (original), all mods, Lead I"),
    ("A3_ecgonly_strat",      "MobileNetV3-S - learned gate, ECG-only, Lead I"),
    ("A4_correctgate_strat",  "MobileNetV3-S - corrected gate + KL, all mods, Lead I"),
    ("A5_normgate_strat",     "MobileNetV3-S - corrected gate + norm + KL, all mods, Lead I"),
